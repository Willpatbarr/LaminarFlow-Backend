...
func listOperation(t *testing.T) *huma.Operation {
	...
	api := NewHumaAPI(http.NewServeMux(), nil, nil, nil, nil, nil, nil, nil)
...
func TestThePublishedPageSizeBoundMatchesTheEnforcedOne(t *testing.T) {
	...
	body := NewHumaAPI(http.NewServeMux(), nil, nil, nil, nil, nil, nil, nil).OpenAPI().Components.Schemas.Map()[name]
	if body == nil {
